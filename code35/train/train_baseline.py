...
def train(mission_id, BATCH_SIZE, EPOCH, LR, LR_DECAY, DECAY_EPOCH):
    # BATCH_SIZE = 54, EPOCH = 100, LR = 0.01, LR_DECAY = 0.25, DECAY_EPOCH = 30
    # Hyper Parameter
    # BATCH_SIZE = 54
    # EPOCH = 100
    # LR = 0.01
    ...
    # mission_kind = 'neck_design_labels'
...
if __name__ == '__main__':
    fire.Fire(train)
    # train(1, BATCH_SIZE=46, EPOCH=100, LR=0.01, LR_DECAY=0.1, DECAY_EPOCH=30)
